...
import com.postech.challenge_01.builder.menu.MenuDTOBuilder;
...
public class MenuGatewayTest {
    ...
    void setUp() {
        ...
        gateway = new MenuGateway(repository);
    }
    ...
    void shouldFindById() {
        // Arrange
        var id = 1L;
        var dto = MenuDTOBuilder.oneMenuDTO()
                .withId(id).build();
    ...
    void shouldFindAll() {
        // Arrange
        var dto1 = MenuDTOBuilder.oneMenuDTO().build();
        var dto2 = MenuDTOBuilder.oneMenuDTO().build();
        var dto3 = MenuDTOBuilder.oneMenuDTO().build();
    ...
    void shouldSave() {
        ...
        var dto = MenuDTOBuilder.oneMenuDTO().build();
        ...
        assertEquals(result.getRestaurantId(), dto.restaurantId());
    }
    ...
    void shouldThrowUpdateWhenEntityNotExist() {
        ...
        // Act + Assert
        assertThrows(UnsupportedOperationException.class, () -> gateway.update(entity, id));
    }
    ...
    void shouldThrowDeleteWhenEntityNotExist() {
        ...
        // Act + Assert
        assertThrows(MenuNotFoundException.class, () -> gateway.delete(id));
    }
}
